  ...
  return (
        <div className="flex h-[700px] w-full">
            <div className="w-full hidden md:inline-block">
                <img className="mt-10 h-full" src={assets.login_page} alt="leftSideImage" />
            </div>
            ...
            <div className="w-full flex flex-col items-center justify-center">
                ...
                <form 
                    ...
                    <h2 className="text-4xl text-gray-900 font-medium">User Sign in</h2>
                    ...
                    <button onClick={() => setState("login")}  type="submit" className="mt-8 w-full h-11 rounded-full text-white bg-primary hover:opacity-90 transition-opacity">
                        Login
